...
Vermeil is free, open-source software licensed under the **MIT License**. The complete source code is publicly accessible on GitHub at [https://github.com/Davekb1976/Vermeil-Launcher](https://github.com/Davekb1976/Vermeil-Launcher).

Subject to the conditions of the MIT License, you are free to inspect, modify, fork, and compile the software.
