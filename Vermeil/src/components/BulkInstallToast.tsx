...
import { isBulkInstall, bulkDone, bulkProgress, activeDownloadCount, downloadToastsEnabled } from "../App";
 ...
 * and download toasts are enabled.
 *
...
const BulkInstallToast: Component = () => {
  return (
    <Show when={isBulkInstall() && downloadToastsEnabled()}>
