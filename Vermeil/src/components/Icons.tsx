...
// Crosshair — Feather Icons (MIT). https://github.com/feathericons/feather
// The colour picker's "pick from screen" (eyedropper) button. A crosshair reads
// as "aim at a point on screen", which is exactly the interaction.
export const IconCrosshair: Component = () => (
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
    <circle cx="12" cy="12" r="10"/>
