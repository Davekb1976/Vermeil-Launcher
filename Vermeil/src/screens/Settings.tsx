          ...
          <div class="settings-section">
            ...
            <div class="settings-group">
              <div class="settings-row">
                ...
                <button class="btn btn--sm" onClick={() => openUrl("https://github.com/Vermeil-Launcher/Vermeil-Launcher")}>
              ...
              <div class="settings-row">
                ...
                <button class="btn btn--sm" onClick={() => openUrl("https://github.com/Vermeil-Launcher/Vermeil-Launcher/blob/main/PRIVACY.md")}>
                  Read policy
                </button>
              </div>
            </div>
